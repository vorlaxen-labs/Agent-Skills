...
name: global
description: >-
  Decision boundaries for all coding tasks. Constrain decisions, not
  implementations. Enforces no hallucination, risk-tiered stop-and-ask, scope control,
  and production outcomes. Use on every project.
---
# Core Principle
